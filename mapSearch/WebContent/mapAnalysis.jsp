      ...
      <div class="row">
         <div class="col-md-4 mb-4">
            <div class="card h-100">
               <div class="card-body">
                  <h2 class="card-title"><font color="#FF8000">예상 매출 : ${sessionScope.result.sales}</font></h2>
                  <p class="card-text">
                     해당 상권의 유동인구, 지출, 주변시설, 배후지 상권등을 머신러닝 기반으로 분석하여 매출을 예상하였습니다<br>
         DNN, 앙상블 기법<br>
                     매출의 예측치는 OO%의 정확도를 보이고 있습니다.<br>
                  </p>
               </div>
         ...
         <div class="col-md-4 mb-4">
            <div class="card h-100">
               <div class="card-body">
                  ...
                  <p class="card-text">
                     해당 상권의 예상등급은 ${sessionScope.result.estimatedClass}입니다.<br>
         군집 분석을 통해서 상권 업종의 안전도를 4가지로 분류 하였습니다.<br>
         각 집단별로 위험, 불안, 양호, 유망으로 나누어 집니다.<br>
    classification을 통해 해당 상권 업종의 창업 기준을 제시합니다.     
                  </p>
               </div>
               <div class="card-footer">
                  <a href="#" class="btn btn-primary">정보 더 보기</a>
         ...
         <div class="col-md-4 mb-4">
            <div class="card h-100">
               <div class="card-body">
                  ...
                  <p class="card-text">
                  해당 상권의 매출은 전국 외식업 골목상권 전체 중 상위 ${sessionScope.result.percentage}%입니다.<br>
                  상권 내 해당 업종은 동종으로 OO개가 있습니다. 
