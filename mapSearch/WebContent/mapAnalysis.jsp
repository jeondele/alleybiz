...
%>
    ...
    <div class="container">
      ...
      <div class="row my-4">
        ...
        <!-- /.col-lg-8 -->
        <div class="col-lg-4">
          <h1><font color="#fc9520">${dataAll.gu}</font><font color="#1f72ef">   ${dataAll.dong}</font><br> 상권 종합 분석</h1>
          <p>해당상권의<br>
          <font color="#1f72ef">${sessionScope.service}</font>업종<br>
          전국 외식업 골목상권 기준 상위<font color="#1f72ef">OO%</font><br>
          상권 안전도 : 좋음 / 보통 / 나쁨
...
daum.maps.event.addListener(polygon, 'click', function(mouseEvent) {
    ...
    '   <div class="title">' + '<strong>상권 명 : '+area.name+'</strong>' + '</div>' +
